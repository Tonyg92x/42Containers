...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/10 11:19:10 by aguay             #+#    #+#             */
/*   Updated: 2022/11/10 11:32:00 by aguay            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class const_iterator
{
    ...
    //  =============== CONSTRUCTOR             ==============  //
        ...
        const_iterator(const_iterator const & rhs) {*this = rhs;}
    ...
    //  =============== OPERATION OVERLOAD'S    =============== //
        ...
        bool    operator==(const_iterator const & rhs) const { return (_ptr == rhs.getPtr());}
